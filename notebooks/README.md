...
Получили модель, построеннаую на полиномиальных и категориальных признаках, полученных после предобработки ранее созданным предобработчиком, с последующим логарифмированием целевой переменной с R^2 = 0.95.
